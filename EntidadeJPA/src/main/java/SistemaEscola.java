...
import Manager.EscolaJpaController;
import Model.Escola;
...
public class SistemaEscola {
    ...
    private final EscolaJpaController dao = new EscolaJpaController(
            Persistence.createEntityManagerFactory(
                    "ExemploEntidadeJPAPU"));
    private static final BufferedReader entrada
            = new BufferedReader(new InputStreamReader(System.in));

    private void exibir(Escola aluno) {
    ...
    public void exibirTodos() {
        System.err.println("Ainda trabalhando nisso");
    }
